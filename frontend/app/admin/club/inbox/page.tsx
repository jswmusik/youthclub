        ...
        <div className="h-[calc(100vh-64px)] flex flex-col overflow-hidden">
            ...
            <div className="hidden md:block px-4 sm:px-6 py-4 sm:py-6 flex-shrink-0">
                <div className="flex items-center gap-3 mb-1">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-[var(--brand-light)]">Club Inbox</h1>
                </div>
                <p className="text-sm text-[var(--brand-light)]/50 pl-[52px]">Chat with members, guardians, and other staff.</p>
            </div>
