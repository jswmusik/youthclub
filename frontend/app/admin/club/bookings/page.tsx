  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#121213]">Bookings Dashboard</h1>
          <p className="text-gray-500 mt-1">Manage booking requests and resources for your club.</p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Link href="/admin/club/bookings/resources">
            <Button variant="outline" className="gap-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50">
              <Package className="h-4 w-4" />
              Manage Resources
            </Button>
          </Link>
          <Link href="/admin/club/bookings/calendar">
