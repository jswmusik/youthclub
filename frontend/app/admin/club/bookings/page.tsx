        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 px-4 sm:px-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[var(--brand-light)]/50 text-sm">Manage booking requests and resources for your club.</p>
            </div>
          </div>
          <div className="flex flex-wrap gap-2 pl-[60px] sm:pl-0">
            <Link 
              href="/admin/club/bookings/resources"
            ...
            <Link 
              href="/admin/club/bookings/calendar"
