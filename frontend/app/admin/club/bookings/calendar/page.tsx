...
function ClubBookingCalendarPageContent() {
    ...
    <div className="min-h-screen bg-[var(--dark-900)]">
      <div className="py-4 sm:py-6 px-0 sm:px-4 space-y-4 sm:space-y-6">
        ...
        <div className="h-[calc(100vh-200px)] min-h-[600px] flex flex-col">
          <BookingCalendar scope="CLUB" ref={calendarRef} />
        </div>
      </div>
    </div>
  );
...
export default function ClubBookingCalendarPage() {
  return (
    <Suspense fallback={
      ...
      <ClubBookingCalendarPageContent />
    </Suspense>
  );
}
