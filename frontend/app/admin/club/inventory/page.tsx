...
export default function InventoryDashboardPage() {
  ...
  useEffect(() => {
    ...
    if (!searchChanged && !categoryChanged && !statusChanged && !hasUserChangedFilters.current) {
      return;
    }
  ...
  }, [searchInput, selectedCategory, selectedStatus, searchParams, pathname, router]);
      ...
      <div className="py-4 sm:py-8 px-0 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4 sm:px-6">
          <div>
            ...
            <p className="text-[var(--brand-light)]/50 text-sm pl-[52px]">{t('clubDescription')}</p>
          </div>
          <div className="flex flex-wrap gap-2 px-4 sm:px-0">
            ...
            <Link href={buildUrlWithParams("/admin/club/inventory/create")}>
