                ...
                <div className="bg-[var(--dark-800)] p-4 sm:p-6 rounded-none sm:rounded-xl border-y sm:border border-[var(--dark-600)]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {data.top_interests.map((interest, i) => (
                      <span 
                        key={i} 
                        className="px-3 py-1.5 bg-[var(--dark-700)] text-[var(--brand-light)]/80 rounded-full text-sm font-medium border border-[var(--dark-500)] hover:border-[var(--brand-primary)]/50 hover:bg-[var(--brand-primary)]/10 transition-all cursor-default group"
                        style={{ 
