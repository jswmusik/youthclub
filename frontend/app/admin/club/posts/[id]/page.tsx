...
import { ArrowLeft, Edit, Eye, MessageSquare, Calendar, User, Users, CheckCircle2, XCircle, Clock, Pin, Trash2, X, ChevronLeft, ChevronRight } from 'lucide-react';
                    ...
                    <Card className="border-none shadow-sm">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                ...
                                <Badge variant="outline" className={post.require_moderation ? 'bg-blue-50 text-[#0EA5E9] border-[#0EA5E9]/30' : 'bg-gray-50 text-gray-700 border-gray-200'}>
                                                ...
                                                <div className="flex justify-between items-start mb-2">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <Button
                                                            ...
                                                            className={comment.is_approved ? 'text-blue-700 border-blue-200 hover:bg-blue-50' : 'text-green-700 border-green-200 hover:bg-green-50'}
                                                        >
                                                            {comment.is_approved ? (
                                                                <>
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {post.target_groups.map((g: any) => (
                                            <Badge key={g} variant="outline" className="bg-blue-50 text-[#0EA5E9] border-[#0EA5E9]/30 text-xs">
                                                Group ID {g}
                                            </Badge>
                                        ))}
                                    </div>
                    ...
                    <Card className="border-none shadow-sm">
                        ...
                        <CardContent className="pt-6 space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline" className={post.allow_comments ? 'bg-green-50 text-[#10B981] border-[#10B981]/30' : 'bg-red-50 text-[#EF4444] border-red-200'}>
                                    {post.allow_comments ? (
                                        <>
                                            <CheckCircle2 className="h-3 w-3 mr-1" />
                                            Allowed
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Badge variant="outline" className={post.send_push_notification ? 'bg-green-50 text-[#10B981] border-[#10B981]/30' : 'bg-gray-50 text-gray-700 border-gray-200'}>
