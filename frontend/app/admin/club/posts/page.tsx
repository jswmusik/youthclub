                ...
                >
                    <div className="p-4">
                        <div className="flex flex-wrap gap-4 items-end">
                            ...
                            {/* Scope - Club admins only see CLUB scope */}
                            <div className="w-48">
                                ...
                                <tr key={post.id} className="hover:bg-gray-50 transition">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center justify-end gap-2">
                                            <Link 
                                                href={buildUrlWithParams(`/admin/club/posts/${post.id}`)} 
                                            ...
                                            <Link 
                                                href={buildUrlWithParams(`/admin/club/posts/edit/${post.id}`)} 
