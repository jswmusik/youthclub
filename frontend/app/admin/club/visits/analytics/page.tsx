      ...
      <div className="max-w-7xl mx-auto space-y-6 px-0 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            ...
            <p className="text-[var(--brand-light)]/50 text-sm pl-[52px]">Analytics & Insights for your club.</p>
          </div>
        </div>
        ...
        {loading ? (
          <div className="bg-[var(--dark-800)] rounded-none sm:rounded-2xl border-y sm:border border-[var(--dark-600)] p-8">
            <div className="py-20 flex justify-center">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-[var(--brand-light)]/50 text-sm">Loading analytics...</p>
              </div>
            </div>
          </div>
        ) : !stats ? (
          <div className="bg-[var(--dark-800)] rounded-none sm:rounded-2xl border-y sm:border border-[var(--dark-600)] p-8 sm:p-12">
            <div className="text-center py-8">
              ...
              <p className="text-[var(--brand-light)]/50 font-medium">Failed to load analytics data</p>
              <p className="text-sm text-[var(--brand-light)]/30 mt-1">No data available or an error occurred.</p>
            </div>
          </div>
        ) : (
          <>
            ...
            <div className="bg-[var(--dark-800)] rounded-none sm:rounded-2xl border-y sm:border border-[var(--dark-600)] overflow-hidden">
              <div className="px-4 sm:px-6 py-4 border-b border-[var(--dark-600)] bg-[var(--dark-700)]/50">
                <div className="flex items-center gap-2">
                  ...
                  <h2 className="text-sm font-semibold text-[var(--brand-light)]">Analytics Dashboard</h2>
                </div>
                <p className="text-xs text-[var(--brand-light)]/50 mt-1">Data for the last {period} days</p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
                  ...
                  <div className="bg-[var(--dark-700)] rounded-xl border-2 border-[var(--dark-500)] p-4 hover:border-[var(--brand-primary)]/50 transition-all">
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <div className="text-sm font-medium text-[var(--brand-light)]/70">Total Visits</div>
                  ...
                  <div className="bg-[var(--dark-700)] rounded-xl border-2 border-[var(--dark-500)] p-4 hover:border-[var(--brand-blue)]/50 transition-all">
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <div className="text-sm font-medium text-[var(--brand-light)]/70">Unique Youth</div>
                  ...
                  <div className="bg-[var(--dark-700)] rounded-xl border-2 border-[var(--dark-500)] p-4 hover:border-[var(--brand-third)]/50 transition-all">
                    <div className="flex flex-col items-center space-y-2">
                      ...
                      <div className="text-sm font-medium text-[var(--brand-light)]/70">Avg. Visits / Youth</div>
