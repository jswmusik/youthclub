  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#121213]">Municipality Bookings Dashboard</h1>
          <p className="text-gray-500 mt-1">Manage booking requests and resources across clubs in your municipality.</p>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <Link href="/admin/municipality/bookings/calendar">
