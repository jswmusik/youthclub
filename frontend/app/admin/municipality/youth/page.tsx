  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={handleOpenCreate} className="bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-пurple-700 shadow">
          + Add Youth
        </button>
      </div>
              ...
              {users.map((youth) => (
                <tr key={youth.id}>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">
                    {clubs.find((club) => club.id === youth.preferred_club)?.name || '—'}
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-600">
