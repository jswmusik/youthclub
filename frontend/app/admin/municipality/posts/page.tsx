    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <Link 
                    href="/admin/municipality/posts/create"
                ...
                >
                    <div className="p-4">
                        <div className="flex flex-wrap gap-4 items-end">
                            ...
                            {/* Scope - No Global option for municipality admins */}
                            <div className="w-48">
                                ...
                                <tr key={post.id} className="hover:bg-gray-50 transition">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center justify-end gap-2">
                                            <Link 
                                                href={buildUrlWithParams(`/admin/municipality/posts/${post.id}`)} 
                                            ...
                                            <Link 
                                                href={buildUrlWithParams(`/admin/municipality/posts/edit/${post.id}`)} 
