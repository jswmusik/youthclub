...
function CustomFieldDetailPageContent() {
  ...
  return (
    <CustomFieldDetailView fieldId={id} basePath="/admin/municipality/custom-fields" />
  );
}
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-[var(--dark-900)] flex flex-col justify-center items-center py-20 gap-4">
        ...
        <div className="text-[var(--brand-light)]/60 animate-pulse">Loading field details...</div>
      </div>
    }>
