      ...
      <div className="py-4 sm:py-8 px-0 space-y-6 max-w-[1600px] mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-4 sm:px-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[var(--brand-purple)] flex items-center justify-center shadow-lg shadow-[var(--brand-purple)]/20 animate-pulse-slow">
