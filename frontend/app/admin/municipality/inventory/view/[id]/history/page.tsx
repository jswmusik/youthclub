...
function ItemHistoryPageContent() {
  ...
  return (
    <div className="py-4 sm:py-8 px-0">
      <ItemHistoryView itemId={params.id as string} basePath="/admin/municipality/inventory" />
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[var(--dark-900)]">
      <Suspense fallback={
        <div className="min-h-screen bg-[var(--dark-900)] flex flex-col justify-center items-center py-20 gap-4">
          ...
          <div className="text-[var(--brand-light)]/60 animate-pulse">Loading history...</div>
        </div>
      }>
