      ...
      <div className="p-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-slate-500">Archive of all check-ins and check-outs for this club.</p>
          </div>
        </div>
        ...
        <div className="border-b border-slate-200 mb-6">
          <nav className="flex space-x-8">
            ...
            <Link 
              ...
              className={`border-b-2 pb-4 px-1 text-sm font-medium ${
                isActiveTab(`/admin/municipality/clubs/${clubId}/visits/analytics`) ? 'border-emerald-500 text-emerald-600' : 'border-transparent text-slate-500 hover:text-slate-700 hover:border-slate-300'
              }`}
            >
              Analytics
            </Link>
