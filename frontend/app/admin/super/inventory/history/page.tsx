...
export default function SuperInventoryHistoryPage() {
    ...
    useEffect(() => {
        ...
        if (!searchChanged && !itemChanged && !clubChanged && !startDateChanged && !endDateChanged && !hasUserChangedFilters.current) {
            return;
        }
    ...
    }, [searchInput, selectedItemId, selectedClubId, startDate, endDate, searchParams, pathname, router]);
    ...
    const hasFilters = searchInput || selectedItemId || selectedClubId || startDate || endDate;
