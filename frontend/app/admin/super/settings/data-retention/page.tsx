...
export default function DataRetentionSettingsPage() {
  ...
  return (
    <div className="py-4 sm:py-6 md:py-8 px-0 space-y-6">
      ...
      {/* Statistics Cards */}
      {statistics && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 px-4 sm:px-6 md:px-8">
      ...
      {!formData.is_auto_deletion_enabled && (
        <div className="mx-4 sm:mx-6 md:mx-8 bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-4 flex items-start gap-3">
        ...
        <div className="bg-[var(--dark-800)] rounded-none md:rounded-2xl border-y md:border border-[var(--dark-600)] overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-[var(--dark-600)] bg-[var(--dark-700)]/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-[var(--brand-light)]">{t('retentionPeriod.title')}</h2>
          ...
          <div className="px-4 sm:px-6 py-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <Label htmlFor="default" className="text-sm font-semibold text-[var(--brand-light)]">
              ...
              <div className="space-y-2">
                <Label htmlFor="min" className="text-sm font-semibold text-[var(--brand-light)]">
              ...
              <div className="space-y-2">
                <Label htmlFor="max" className="text-sm font-semibold text-[var(--brand-light)]">
        ...
        <div className="bg-[var(--dark-800)] rounded-none md:rounded-2xl border-y md:border border-[var(--dark-600)] overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-[var(--dark-600)] bg-[var(--dark-700)]/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-[var(--brand-light)]">{t('warningNotifications.title')}</h2>
          ...
          <div className="px-4 sm:px-6 py-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="warning1" className="text-sm font-semibold text-[var(--brand-light)]">
              ...
              <div className="space-y-2">
                <Label htmlFor="warning2" className="text-sm font-semibold text-[var(--brand-light)]">
        ...
        <div className="bg-[var(--dark-800)] rounded-none md:rounded-2xl border-y md:border border-[var(--dark-600)] overflow-hidden">
          <div className="px-4 sm:px-6 py-4 border-b border-[var(--dark-600)] bg-[var(--dark-700)]/30">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-semibold text-[var(--brand-light)]">{t('systemControl.title')}</h2>
          ...
          <div className="px-4 sm:px-6 py-4 border-b border-[var(--dark-600)] bg-[var(--dark-700)]/30">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="font-semibold text-[var(--brand-light)]">{t('pendingDeletions.title')}</h2>
        ...
        <div className="bg-[var(--dark-800)] rounded-none md:rounded-2xl border-y md:border border-[var(--dark-600)] overflow-hidden">
          <div className="flex justify-end pt-4 border-t border-[var(--dark-600)] px-4 sm:px-6 md:px-8 pb-4 sm:pb-6 md:pb-8">
            <Button
              ...
              disabled={isSaving}
            >
              {isSaving ? t('buttons.saving') : t('buttons.saveSettings')}
            </Button>
          </div>
        </div>
      </form>
