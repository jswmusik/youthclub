...
export default function EventDashboardPage() {
    ...
    const t = useTranslations('eventsAdmin.detail');
    ...
    const getTranslatedStatus = (status: string) => {
        switch (status) {
            case 'PUBLISHED': return tStatus('published');
            case 'DRAFT': return tStatus('draft');
            case 'SCHEDULED': return tStatus('scheduled');
                ...
                <div className="bg-[var(--dark-800)] rounded-none sm:rounded-2xl border-y sm:border border-[var(--dark-600)] overflow-hidden">
                    ...
                    >
                        ...
                        <div className={`absolute top-4 right-4 px-4 py-2 rounded-xl backdrop-blur-sm border flex items-center gap-2 ${getStatusBadgeClasses(event.status)}`}>
                            ...
                            <span className="text-sm font-semibold">{getTranslatedStatus(event.status)}</span>
                        </div>
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                    ...
                                    <div className="p-4 rounded-xl bg-[var(--dark-700)]/50 border border-[var(--brand-primary)]/30 hover:border-[var(--brand-primary)]/50 transition-all">
                                        ...
                                        <p className="text-xs text-[var(--brand-light)]/50 mt-1">
                                            {event.max_seats === 0 ? t('unlimited') : t('ofSeats', { count: event.max_seats })}
                                        </p>
                                    </div>
                                            ...
                                            <div className="space-y-1">
                                                ...
                                                {event.target_groups_details.length > 3 && (
                                                    <div className="text-xs text-[var(--brand-light)]/50">
                                                        {t('more', { count: event.target_groups_details.length - 3 })}
                                                    </div>
                                                )}
                                            </div>
                                        ) : (
                        ...
                        {activeTab === 'CHECKIN' && (
                            <div className="space-y-6">
                                <div className="flex items-center justify-between">
                                    <h3 className="text-lg font-semibold text-[var(--brand-light)]">{t('checkIn.title')}</h3>
                                    <span className="text-sm text-[var(--brand-light)]/50">
                                        {t('checkIn.checkedIn', { count: registrations.filter((r: any) => r.status === 'ATTENDED' || r.ticket?.checked_in_at).length })}
                                    </span>
                                </div>
                                    ...
                                    if (checkedInRegistrations.length === 0) {
                                        return (
                                            <div className="py-16 text-center">
                                                ...
                                                <p className="font-medium text-[var(--brand-light)] mb-1">{t('checkIn.noCheckIns')}</p>
                                                <p className="text-sm text-[var(--brand-light)]/50">{t('checkIn.noCheckInsDesc')}</p>
                                            </div>
                                        );
                                    }
                                                ...
                                                return (
                                                    <div key={reg.id} className="flex items-center gap-4 p-4 rounded-xl bg-[var(--dark-700)]/50 border border-[var(--dark-500)]">
                                                        ...
                                                        <div className="text-right hidden sm:block">
                                                            <div className="text-xs text-[var(--brand-light)]/50 mb-1">{t('checkIn.ticket')}</div>
                                                        ...
                                                        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--brand-green)]/20 text-[var(--brand-green)] text-xs font-medium">
                                                            ...
                                                            <span className="hidden sm:inline">{t('checkIn.checkedInBadge')}</span>
                                                        </div>
                                                    </div>
                                                );
                                            })}
                                ...
                                <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.basicInformation')}</h3>
                                        </div>
                                        <div className="p-5 space-y-4">
                                            <div>
                                                <label className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1 block">{t('overview.title')}</label>
                                                <p className="text-lg font-semibold text-[var(--brand-light)]">{event.title}</p>
                                            </div>
                                            <div>
                                                <label className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1 block">{t('overview.description')}</label>
                                            ...
                                            {event.cost !== null && event.cost !== undefined && (
                                                <div>
                                                    <label className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1 block">{t('overview.cost')}</label>
                                                    <p className="text-lg font-semibold text-[var(--brand-light)]">
                                                        {parseFloat(event.cost.toString()) === 0 ? t('overview.free') : `$${parseFloat(event.cost.toString()).toFixed(2)}`}
                                                    </p>
                                                </div>
                                            )}
                                        </div>
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.dateTime')}</h3>
                                        </div>
                                        <div className="p-5">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div className="p-4 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                    <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1">{t('overview.start')}</div>
                                                ...
                                                <div className="p-4 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                    <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1">{t('overview.end')}</div>
                                                    <div className="text-sm text-[var(--brand-light)] font-medium">
                                            ...
                                            {event.is_recurring && (
                                                <div className="mt-4 p-4 rounded-xl bg-[var(--brand-purple)]/10 border border-[var(--brand-purple)]/30">
                                                    ...
                                                    <div className="text-xs text-[var(--brand-light)]/60">
                                                        {t('overview.pattern')}: {event.recurrence_pattern || 'NONE'}
                                                        {event.recurrence_end_date && (
                                                            <span> • {t('overview.ends')}: {new Date(event.recurrence_end_date).toLocaleDateString()}</span>
                                                        )}
                                                    </div>
                                                </div>
                                            )}
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.location')}</h3>
                                        </div>
                                        <div className="p-5 space-y-3">
                                            <div className="p-4 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1">{t('overview.locationName')}</div>
                                                <div className="text-sm text-[var(--brand-light)] font-medium">{event.location_name}</div>
                                            </div>
                                            {event.address && (
                                                <div className="p-4 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                    <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1">{t('overview.address')}</div>
                                            ...
                                            <div className="flex items-center gap-2 text-xs text-[var(--brand-light)]/50">
                                                ...
                                                {event.is_map_visible ? t('overview.mapVisible') : t('overview.mapHidden')}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.registrationSettings')}</h3>
                                        </div>
                                        <div className="p-5 space-y-4">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.registration')}</span>
                                                <span className={`px-3 py-1 rounded-lg text-xs font-medium ${event.allow_registration ? 'bg-[var(--brand-green)]/20 text-[var(--brand-green)]' : 'bg-[var(--dark-600)] text-[var(--brand-light)]/50'}`}>
                                                    {event.allow_registration ? t('overview.enabled') : t('overview.disabled')}
                                                </span>
                                            </div>
                                            {event.allow_registration && (
                                                <>
                                                    <div className="grid grid-cols-2 gap-4">
                                                        <div className="p-4 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                            <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1">{t('overview.maxSeats')}</div>
                                                            <div className="text-lg font-semibold text-[var(--brand-light)]">
                                                                {event.max_seats === 0 ? '∞' : event.max_seats}
                                                            </div>
                                                        </div>
                                                        <div className="p-4 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                            <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-1">{t('overview.waitlist')}</div>
                                                            <div className="text-lg font-semibold text-[var(--brand-light)]">
                                                                {event.max_waitlist === 0 ? t('overview.none') : event.max_waitlist}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="space-y-2 pt-2">
                                                        <div className="flex items-center gap-2 text-sm text-[var(--brand-light)]/70">
                                                            ...
                                                            {t('overview.guardianApproval')} {event.requires_guardian_approval ? t('overview.required') : t('overview.notRequired')}
                                                        </div>
                                                        <div className="flex items-center gap-2 text-sm text-[var(--brand-light)]/70">
                                                            <span className={`w-2 h-2 rounded-full ${event.requires_admin_approval ? 'bg-[var(--brand-green)]' : 'bg-[var(--dark-500)]'}`}></span>
                                                            {t('overview.adminApproval')} {event.requires_admin_approval ? t('overview.required') : t('overview.notRequired')}
                                                        </div>
                                                    </div>
                                                </>
                                            )}
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.organization')}</h3>
                                        </div>
                                        <div className="p-5 space-y-3">
                                            <div className="p-3 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-0.5">{t('overview.municipality')}</div>
                                                <div className="text-sm text-[var(--brand-light)] font-medium">
                                            ...
                                            {(event.club_detail || event.club) && (
                                                <div className="p-3 rounded-xl bg-[var(--dark-600)]/50 border border-[var(--dark-500)]">
                                                    <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-0.5">{t('overview.club')}</div>
                                                    <div className="text-sm text-[var(--brand-light)] font-medium">
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.targeting')}</h3>
                                        </div>
                                        <div className="p-5 space-y-4">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.audience')}</span>
                                                <span className="text-sm text-[var(--brand-light)] font-medium">{event.target_audience}</span>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.visibility')}</span>
                                                <span className={`px-3 py-1 rounded-lg text-xs font-medium ${event.is_global ? 'bg-[var(--brand-blue)]/20 text-[var(--brand-blue)]' : 'bg-[var(--dark-600)] text-[var(--brand-light)]/50'}`}>
                                                    {event.is_global ? t('global') : t('overview.limited')}
                                                </span>
                                            </div>
                                            {event.target_groups_details && event.target_groups_details.length > 0 && (
                                                <div>
                                                    <div className="text-[10px] text-[var(--brand-light)]/40 uppercase font-semibold mb-2">{t('overview.targetGroups')}</div>
                                            ...
                                            {(event.target_min_age || event.target_max_age) && (
                                                <div className="text-sm text-[var(--brand-light)]/70">
                                                    {t('overview.age')}: {event.target_min_age || t('overview.any')} - {event.target_max_age || t('overview.any')}
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.notifications')}</h3>
                                        </div>
                                        <div className="p-5 space-y-3">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.reminders')}</span>
                                                <span className={`px-3 py-1 rounded-lg text-xs font-medium ${event.send_reminders ? 'bg-[var(--brand-green)]/20 text-[var(--brand-green)]' : 'bg-[var(--dark-600)] text-[var(--brand-light)]/50'}`}>
                                                    {event.send_reminders ? t('overview.on') : t('overview.off')}
                                                </span>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.tickets')}</span>
                                                <span className={`px-3 py-1 rounded-lg text-xs font-medium ${event.enable_tickets ? 'bg-[var(--brand-green)]/20 text-[var(--brand-green)]' : 'bg-[var(--dark-600)] text-[var(--brand-light)]/50'}`}>
                                                    {event.enable_tickets ? t('overview.enabled') : t('overview.disabled')}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-[var(--dark-700)]/50 rounded-xl border border-[var(--dark-500)] overflow-hidden">
                                        <div className="px-5 py-4 border-b border-[var(--dark-500)] bg-[var(--dark-600)]/30 flex items-center gap-3">
                                            ...
                                            <h3 className="font-semibold text-[var(--brand-light)]">{t('overview.status')}</h3>
                                        </div>
                                        <div className="p-5 space-y-3">
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.status')}</span>
                                            ...
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.confirmed')}</span>
                                                <span className="text-sm text-[var(--brand-light)] font-semibold">{event.confirmed_participants_count}</span>
                                            </div>
                                            <div className="flex items-center justify-between">
                                                <span className="text-sm text-[var(--brand-light)]/70">{t('overview.waitlist')}</span>
