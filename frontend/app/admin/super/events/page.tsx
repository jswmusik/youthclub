...
export default function SuperEventsPage() {
    ...
    const fetchEvents = async () => {
        try {
            // The backend ViewSet automatically filters for the super admin
        ...
        <div className="max-w-6xl mx-auto p-6">
            <div className="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p className="text-gray-500">Manage all events across the system</p>
                </div>
                <Link 
                    href="/admin/super/events/create" 
                                ...
                                <tr key={event.id} className="hover:bg-gray-50 transition">
                                    ...
                                    <td className="p-4">
                                        <div className="flex gap-3 text-sm">
                                            <Link href={`/admin/super/events/edit/${event.id}`} className="text-blue-600 hover:underline">
                                                Edit
                                            </Link>
                                            <Link href={`/admin/super/events/${event.id}`} className="text-gray-600 hover:underline">
                                                Manage
                                            </Link>
                                        </div>
                                    </td>
