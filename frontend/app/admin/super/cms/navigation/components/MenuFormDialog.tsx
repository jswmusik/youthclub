    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70">
      <div className="bg-[var(--dark-800)] rounded-2xl w-full max-w-md border border-[var(--dark-600)] overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-[var(--brand-light)]/70 mb-2">Label</label>
            <input
              type="text"
              value={label}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-[var(--brand-light)]/70 mb-2">Link Type</label>
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--brand-light)]/70 mb-2">Order</label>
              <input
                type="number"
                value={order}
          ...
          {linkType === 'page' ? (
            <div>
              <label className="block text-sm font-medium text-[var(--brand-light)]/70 mb-2">Select Page</label>
              <select
                value={pageId}
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--brand-light)]/70 mb-2">External URL</label>
              <input
                type="url"
                value={externalUrl}
