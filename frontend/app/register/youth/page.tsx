          ...
          <div className="space-y-6">
            <div className={`transition-all duration-700 delay-200 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <h1 className="text-3xl xl:text-4xl font-bold text-white leading-tight font-heading">
                {t('hero.titleLine1')}
                <span className="block text-[var(--brand-primary)]">{t('hero.titleLine2')}</span>
              </h1>
            ...
            <div className={`space-y-3 transition-all duration-700 delay-400 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <BenefitItem icon={<Users className="w-4 h-4" />} text={t('benefits.connectFriends')} color="var(--brand-primary)" />
              <BenefitItem icon={<Calendar className="w-4 h-4" />} text={t('benefits.discoverEvents')} color="var(--brand-purple)" />
              <BenefitItem icon={<Gift className="w-4 h-4" />} text={t('benefits.earnRewards')} color="var(--brand-third)" />
              <BenefitItem icon={<Star className="w-4 h-4" />} text={t('benefits.trackActivities')} color="var(--brand-peach)" />
            </div>
          </div>
