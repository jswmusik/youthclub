...
export default function PostRichTextEditor({ 
  ...
  return (
    <div className="post-rich-editor" ref={containerRef}>
      <ReactQuill 
        ref={quillRef}
        theme="snow" 
        value={value} 
      ...
      <style jsx global>{`
        ...
        .post-rich-editor .ql-toolbar button.ql-clean-formatting {
          background: var(--dark-600);
        }
        
        .post-rich-editor .ql-toolbar button.ql-clean-formatting .ql-stroke {
          stroke: var(--brand-light);
          opacity: 0.7;
        }
        
        :root:not(.dark) .post-rich-editor .ql-toolbar button.ql-clean-formatting .ql-stroke {
          stroke: #374151;
          opacity: 0.7;
        }
        
        .post-rich-editor .ql-toolbar button.ql-clean-formatting:hover {
          background: rgba(239, 68, 68, 0.2);
        }
        
        .post-rich-editor .ql-toolbar button.ql-clean-formatting:hover .ql-stroke {
          stroke: #ef4444;
          opacity: 1;
        }
        
        :root:not(.dark) .post-rich-editor .ql-toolbar button.ql-clean-formatting:hover .ql-stroke {
          stroke: #ef4444;
          opacity: 1;
        }
