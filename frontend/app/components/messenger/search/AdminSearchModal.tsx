                    ...
                    <div className={`p-6 border-b ${darkMode ? 'border-[var(--dark-500)]' : 'border-gray-200'}`}>
                        ...
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg className={`h-5 w-5 ${darkMode ? 'text-[var(--brand-light)]/40' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <li key={admin.id}>
                                        ...
                                        >
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className={`font-semibold ${darkMode ? 'text-[var(--brand-light)]' : 'text-gray-900'}`}>
                                                    {admin.first_name} {admin.last_name}
                                                    {admin.nickname && (
                                                        <span className={`font-normal ml-2 ${darkMode ? 'text-[var(--brand-light)]/60' : 'text-gray-500'}`}>({admin.nickname})</span>
                                                    )}
                                                </div>
                                                <div className={`text-sm truncate ${darkMode ? 'text-[var(--brand-light)]/60' : 'text-gray-500'}`}>{admin.email}</div>
                                            ...
                                            {/* Arrow */}
                                            <svg className={`w-5 h-5 ${darkMode ? 'text-[var(--brand-light)]/40' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
