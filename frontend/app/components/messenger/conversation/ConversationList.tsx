...
function SwipeableItem({ children, onHide, onDelete, darkMode, conversationId }: SwipeableItemProps) {
...
export default function ConversationList({ conversations, selectedId, onSelect, onRefresh, darkMode = false }: ConversationListProps) {
    ...
    return (
        ...
        <ConfirmationModal
            ...
            message={`Hide "${modalState.conversationSubject}"? It will reappear when you receive a new message.`}
        ...
        <ConfirmationModal
            ...
            message={`Are you sure you want to permanently delete "${modalState.conversationSubject}"? This action cannot be undone.`}
