                            ...
                            {showSkeleton ? (
                                ...
                                <>
                                    ...
                                    {!selectedTag && !searchQuery && heroArticle && (
                                        <NewsHero article={heroArticle} darkMode={true} basePath="/dashboard/guardian/news" />
                                    )}

                                    {/* News Grid */}
                                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6">
                                        {articles.map(article => (
                                            <NewsCard key={article.id} article={article} darkMode={true} basePath="/dashboard/guardian/news" />
                                        ))}
                                    </div>
