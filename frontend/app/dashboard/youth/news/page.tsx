                            ...
                            {showSkeleton ? (
                                        ...
                                        <input 
                                            ...
                                            className={`w-full pl-10 pr-4 py-3 rounded-xl outline-none transition-all ${
                                                darkMode 
                                                    ...
                                                    : 'bg-white border border-[#4D4DA4]/15 text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-[#4D4DA4]/30 focus:border-[#4D4DA4]'
                                            }`}
                                            value={searchInput}
                                        ...
                                        className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${
                                            selectedTag === null 
                                                ...
                                                : darkMode 
                                                    ...
                                                    : 'bg-[#EBEBFE] text-gray-600 hover:bg-[#4D4DA4]/20 border border-[#4D4DA4]/15'
                                        }`}
                                    >
                                        {t('allStories')}
                                    </button>
                                ...
                                {hasActiveFilters && (
                                    ...
                                    {!selectedTag && !searchQuery && heroArticle && (
                                        <NewsHero article={heroArticle} darkMode={darkMode} />
                                    )}
                                            ...
                                            <button 
                                                ...
                                                className={`px-8 py-3 border font-medium rounded-xl transition-all disabled:opacity-50 ${
                                                    darkMode 
                                                        ...
                                                        : 'bg-white border-[#4D4DA4]/15 text-gray-700 hover:bg-[#EBEBFE] hover:border-[#4D4DA4]/30'
                                                }`}
                                            >
                                                {loadingMore ? (
