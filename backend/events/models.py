...
class Event(models.Model):
    ...
    cover_image = models.FileField(upload_to='events/covers/', blank=True, null=True)
    video_url = models.URLField(blank=True, null=True, help_text="Optional YouTube embed link")
